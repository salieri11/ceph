...
class TestFSCryptRMW(FSCryptTestCase):
    ...
    def test_fscrypt_overwrite_block_boundary(self):
        ...
        offset = 3379
        contents = 's' * size
        self.mount_a.write_file(path=file, data=contents, offset=offset)
    ...
    def strided_tests(self, fscrypt_block_size, write_size, num_writes, shared_file, fill):
        ...
        contents = fill * fscrypt_block_size
        ...
        for i in range(num_writes):
            ...
            wside.write_file(path=shared_file, data=strided_write, offset=offset, sync=True)
